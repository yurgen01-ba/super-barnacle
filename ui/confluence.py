...
def _render_active_job(project_id: str):
    ...
    active_job = service.latest(active_only=True, project_id=project_id, source_section="confluence")
    ...
    latest_job = service.latest(active_only=False, project_id=project_id, source_section="confluence")
    if latest_job:
